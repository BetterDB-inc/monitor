...
-- With embedding cache ENABLED --
  After 1st call (same text):  1 embedFn call(s)
  After 2nd call (same text):  1 embedFn call(s) [cached!]
  After 3rd call (diff text):  2 embedFn call(s)

-- With embedding cache DISABLED --
  After 1st call (same text):  1 embedFn call(s)
  After 2nd call (same text):  2 embedFn call(s)
  After 3rd call (diff text):  3 embedFn call(s)
