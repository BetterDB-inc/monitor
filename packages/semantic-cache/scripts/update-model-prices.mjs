 ...
 * and writes packages/semantic-cache/src/defaultCostTable.ts.
 *
 * Run via: pnpm --filter @betterdb/semantic-cache update:pricing
 */
...
async function fetchJson(url, opts = {}) {
  const res = await fetch(url, {
    headers: { 'User-Agent': 'betterdb-semantic-cache-pricing-updater', ...opts.headers },
    ...opts,
  });
  if (!res.ok) {
