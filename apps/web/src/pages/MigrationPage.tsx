...
import type { MigrationAnalysisResult, ExecutionMode } from '@betterdb/shared';
...
type Phase = 'idle' | 'analyzing' | 'analyzed' | 'executing' | 'executed';
