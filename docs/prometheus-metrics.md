...
| `betterdb_acl_denied_by_user`                                                                | U            | Distinct usernames seen in ACL audit data since BetterDB started.                                                                                                             | zeroed       |
