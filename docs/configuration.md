...
| `AUTH_BROKER_DISABLED`    | No       | `false`                | Hide the Google and GitHub sign-in buttons, e.g. for air-gapped installs                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `AUTH_BROKER_PUBLIC_KEY`  | No       | embedded key           | Replaces the embedded broker verification key. Staging only                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
